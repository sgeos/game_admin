...
SECRET_KEY = "tq#h4dbkq+j6f62btl!yjrr=b84%%13fq3r1*v8oe2)=l-slgm"
...
DEFAULT_FROM_EMAIL = "hello@game_admin.com"
SERVER_EMAIL = "error@game_admin.com"
from game_admin.settings.app import *
...
GRAPPELLI_ADMIN_TITLE = 'game_admin'
